...
**Photo (Design 5):** Operator night Lower Manhattan skyline — `public/linkedin-banner/manhattan-skyline-night.png`. Legacy day Unsplash file kept at `manhattan-skyline.jpg`.
