...
export const API_RATE_LIMITS: Record<string, RateLimitConfig> = {
  ...
  "/api/demo/clinical/crm/feed": { limit: 60, windowMs: 60_000 },
  "/api/demo/clinical/crm/session": { limit: 30, windowMs: 60_000 },
  "/api/demo/wellness/crm/feed": { limit: 60, windowMs: 60_000 },
  "/api/demo/wellness/crm/session": { limit: 30, windowMs: 60_000 },
  ...
  "/api/voice-demo/clinical/start": { limit: 6, windowMs: 60_000 },
  "/api/voice-demo/wellness/start": { limit: 6, windowMs: 60_000 },
