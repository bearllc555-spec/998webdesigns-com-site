/**
 * Apply supabase/migrations/20260702180000_scorecard_crm_ready_notify.sql to helmet.
 */
import fs from "fs";
...
const migrationPath = path.join(
  ...
  "supabase",
  "migrations",
  "20260702180000_scorecard_crm_ready_notify.sql"
);
    ...
    try {
      ...
      const cols = await client.query(`
        ...
        where table_schema = 'public'
          ...
          and column_name = 'crm_ready_notified_at'`);
      console.log("OK crm_ready_notified_at:", cols.rows.length > 0);
