...
import { SCORECARD_ESTIMATE_SEC, SCORECARD_POLL_MAX_SEC } from "@/lib/scorecard/estimate";
  ...
  return (
    <div className="mt-6 rounded-lg bg-[#e1f5ee] px-4 py-4 text-[#0f6e56]">
      ...
      <p className="mt-3 text-xs text-[#6b6b66]">
        We&apos;ll email a copy to <span className="font-medium text-[#1a1a1a]">{email}</span> when
        it&apos;s ready.
      </p>
    </div>
  );
