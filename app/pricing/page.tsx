...
const pricingDescription = `Flat $7,998 design fee. First ${HOSTING_TRIAL_DAYS} days of hosting free - then ${HOSTING_MONTHLY_PRICE_MO_LABEL} or $2,996 10-year. No tiers, no hidden fees.`;
