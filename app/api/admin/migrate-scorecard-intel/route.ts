...
import { runScorecardInternalIntelMigration } from "@/lib/pg-migrate-scorecard-intel";

export const runtime = "nodejs";
export const dynamic = "force-dynamic";

/** POST - add scorecard_reports.internal_intel + strip from public RPC. Bearer: BALANCE_CAPTURE_SECRET. */
export async function POST(req: NextRequest) {
  ...
  const result = await runScorecardInternalIntelMigration();
  if (!result.ok) {
